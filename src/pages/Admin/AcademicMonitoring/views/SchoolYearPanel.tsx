    ...
    <>
      <Card>
        <CardHeader>
          <div className="flex items-center gap-3 flex-wrap">
            <div className="flex items-center gap-2 shrink-0">
              ...
              <CardTitle className="text-(--darkBlueColor) text-lg whitespace-nowrap">
                ...
                {(schoolYears as any[]).map((year: any) => {
                  ...
                  return (
                    <span
                      ...
                      className={`
                        inline-flex items-center gap-1.5 rounded-lg border-2 px-3 py-1.5 text-sm font-medium
                      ...
                      `}
                    >
                      {isActive && <span className="size-1.5 rounded-full bg-(--greenColor)" />}
                      {year.name}
                    </span>
                  );
                })}
        ...
        <CardContent className="space-y-6">
          {/* Levels section - inline with title */}
          {levels.length > 0 && (
            <div className="flex items-center gap-3 flex-wrap">
              <div className="flex items-center gap-2 shrink-0">
                <Layers className="size-4 text-(--blueColor)" />
                <h3 className="text-sm font-semibold text-(--darkBlueColor) whitespace-nowrap">
                  Niveles
                </h3>
              </div>
                ...
                {sortedLevels.map((level: any) => (
                  <div key={level.id} className="flex items-stretch">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center border border-r-0 border-gray-200 bg-white px-1.5 text-(--lightBlueColor) transition-all hover:text-(--blueColor) hover:border-(--blueColor) cursor-pointer"
                    >
                    ...
                    <AlertDialog>
                      <AlertDialogTrigger asChild>
                        <button
                          ...
                          className="flex items-center justify-center rounded-r-lg border border-gray-200 bg-white px-1.5 text-(--lightBlueColor) transition-all hover:text-red-500 hover:border-red-300 cursor-pointer"
                        >
          ...
          {/* Sections management for selected year */}
          {selectedYear ? (
