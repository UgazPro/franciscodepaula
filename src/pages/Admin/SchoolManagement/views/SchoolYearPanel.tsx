...
import { useSchoolYears, useLevels, useSections, useActiveSchoolYear } from "@/hooks/useSchoolYears";
import {
  useCreateSection,
  useUpdateSection,
  useDeleteSection,
    ...
    <>
      <Card>
        <CardContent className="pt-6">
          ...
          {selectedYear ? (
              ...
              <div className="space-y-2">
                {sortedLevels.map((level: any) => {
                  ...
                  return (
                    <div
                      key={level.id}
                      className="grid grid-cols-[auto_1fr] gap-4 items-center rounded-lg border border-gray-100 bg-gray-50/50 px-4 py-3 transition-colors hover:bg-gray-100/50"
                    >
                      {/* Left: Level name + actions */}
                      <div className="flex items-center gap-2 min-w-[180px]">
                        <span className="text-sm font-medium text-(--darkBlueColor)">
                          {level.level}
                        </span>
                        <button
                          type="button"
                          ...
                          className="p-1 text-(--lightBlueColor) transition-all hover:text-(--blueColor) cursor-pointer"
                        >
                        ...
                        <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <button
                              ...
                              className="p-1 text-(--lightBlueColor) transition-all hover:text-red-500 cursor-pointer"
                            >
                                ...
                                <AlertDialogContent>
                                  <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                      ...
                                      <strong>{sec.section}</strong> de {level.level}?
            ...
            <div className="flex flex-col items-center justify-center py-10 text-(--lightBlueColor)">
              <p className="text-sm font-medium">
                Selecciona un año escolar para gestionar sus niveles y secciones
              </p>
            </div>
          ) : (
          ...
          {/* Add level button */}
          {selectedYear && sortedLevels.length > 0 && (
            <div className="mt-4">
              <Button
                type="button"
                variant="ghost"
